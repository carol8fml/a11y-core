...
This repository contains the component library for a Web Accessibility-focused (WCAG) design system and automated code quality.

## Documentation and Project Status

The project's complete visual documentation is available on Storybook, hosted via GitHub Pages.

[![CI Status](https://github.com/carol8fml/a11y-core/actions/workflows/ci.yml/badge.svg)](https://github.com/carol8fml/a11y-core/actions/workflows/ci.yml)
[![A11y Tests](https://img.shields.io/badge/A11y_Tests-Passed-brightgreen?style=flat&logo=accessibility)](https://github.com/carol8fml/a11y-core/actions/workflows/ci.yml)
[![Documentation](https://img.shields.io/badge/Storybook-Live_Demo-FF4785?style=flat&logo=storybook)](https://carol8fml.github.io/a11y-core)
...
| **Architecture** | **Clean Architecture / Headless** | **Enforces Clean Architecture principles (SOLID)** and clear separation of concerns for **scalable** state management. |
